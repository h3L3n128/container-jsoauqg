...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jsoauqg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jsoauqg.containers.anotherwebservice.com/
...
```
git clone git@github.com:h3L3n128/container-jsoauqg.git
cd container-jsoauqg
```
...
```
docker attach container-jsoauqg
```
